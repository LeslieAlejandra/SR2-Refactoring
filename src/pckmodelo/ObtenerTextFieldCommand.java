 ...
 */
public class ObtenerTextFieldCommand extends Command {
    ...
    public ObtenerTextFieldCommand(Conexion con,BaseDatos bd,String query,javax.swing.JTextField receptor)
    {
           this.bd=bd;
           this.con=con;
           this.query=query;

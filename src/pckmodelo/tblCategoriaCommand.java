 ...
 */
public class tblCategoriaCommand extends Command {
    ...
    public tblCategoriaCommand(Conexion con, BaseDatos receptor, String query, javax.swing.JTable tabla, int rows) {
    ...
    public void execute() {
        ...
        try {
            ...
            while (receptor.dataSet.next()) {
                ...
                tabla1.setValueAt(receptor.dataSet.getInt("Id_categorias"), i, 0);

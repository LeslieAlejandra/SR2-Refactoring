 ...
 */
public class tblPerfilCommand extends Command {
    ...
    public tblPerfilCommand(Conexion con, BaseDatos receptor, String query, javax.swing.JTable tabla, int rows) {
    ...
    public void execute() {
        ...
        try {
            ...
            while (receptor.dataSet.next()) {
                ...
                tabla1.setValueAt(receptor.dataSet.getString("Id_perfil"), i, 0);

...
public class ActividadCotidiana extends Actividad {

	public ActividadCotidiana()
        {
            super();
            cambiarEstado(DesarrolloAct_Cot.Instancia());
	}
	...
	@Override public String registrar(int opc)
        {
            ...
            case 1://hace el insert
                cadena= "insert into actividad(Id_subcategorias,Id_estado,Id_usuario,Comentario,FechaI) values ('" + subcat + "','" + estado + "','" + Usuario.id + "','" + comentario + "', " + fecha + ")";
                break;
            case 2://hace un update
                cadena= "update actividad set Id_estado= '" + estado + "',Tiempo= (Tiempo + " + tiempo + "),FechaF= " + fecha + ",Comentario='" + comentario + "' where Id_actividad=" + id + " and Id_usuario=" + Usuario.id;
                break;
            case 3://hace un delete
                cadena= "delete from actividad where Id_actividad=" + id + " and Id_usuario=" + Usuario.id;
                break;
            }
            return cadena;
	}

...
public class CbPerfilCommand extends Command {
    private Conexion con;
    private String query;
    private BaseDatos receptor;
    private javax.swing.JComboBox combo1;
    
    public CbPerfilCommand(Conexion con,BaseDatos receptor,String query,javax.swing.JComboBox combo)
    {
    ...
    @Override public void execute()
    {
        ...
        try{
            while(receptor.dataSet.next()){
                ...
                //System.out.println(receptor.dataSet.getString("Descripcion"));

 ...
 * @author Orlando
 */
public class FrameMetricaFMFAC extends javax.swing.JInternalFrame {
    
    private Contexto m_Contexto;
    private ArrayList<File> listaArchivos = new ArrayList<File>();

    /**
     * Creates new form FrameMetricaFMFAC
     */
    public FrameMetricaFMFAC() {
        initComponents();
    }
    
    public FrameMetricaFMFAC(File[] archivos)
    {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Factor Medio de Flexibilidad por Arquitectura de Clase");
        setPreferredSize(new java.awt.Dimension(617, 292));

        jLabel3.setBackground(new java.awt.Color(0, 0, 0));
        jLabel3.setFont(new java.awt.Font("Impact", 0, 24)); // NOI18N
        jLabel3.setText("Métrica FMFAC");

        jLabel2.setBackground(new java.awt.Color(0, 0, 0));
        jLabel2.setFont(new java.awt.Font("Impact", 0, 24)); // NOI18N
        jLabel2.setText("Factor Medio de Flexibilidad");
        ...
        jLabel4.setText("Por Arquitectura de Clase");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MMetricasSW m_MMetricasSW = new MetricaFMFAC();
